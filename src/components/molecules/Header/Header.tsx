...
export const Header: React.FC = (): JSX.Element => {
  ...
  return (
    <header className="w-screen fixed top-0 right-0 bg-[#fafafa] dark:bg-[#101030] z-50 py-3 px-24 max-sm:px-4 flex justify-between items-center border-b border-slate-200 dark:border-slate-600">
      <Logo />
